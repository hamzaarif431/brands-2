...
if ($(this).scrollTop() > 300) {
    $('.proimg').animate({width:'80%'},6000,function(){
...
$('.mcount').each(function () {
	...
	$('.about-sec .nav-tabs li').click(function(){
        //alert('lkjlkj');
		setTimeout(function(){$(window).scrollTop( $(window).scrollTop() + 1 ).scrollTop( $(window).scrollTop() - 1 );},0);
    });
